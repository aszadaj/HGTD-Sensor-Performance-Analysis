    ...
    for runLog in runLog_batch:
        ...
        for index in range(0, len(runLog)):
            ...
            if (md.isTrackingFileAvailable()):
                ...
                results_batch.append([peak_values_run, rise_times_run, tracking_run, time_difference_peak_run, time_difference_cfd05_run])
        ...
        if len(results_batch) != 0:
            ...
            tracking                        = np.empty(0, dtype=results_batch[0][2].dtype)
            time_difference_peak            = np.empty(0, dtype=results_batch[0][3].dtype)
            time_difference_cfd05           = np.empty(0, dtype=results_batch[0][4].dtype)
            ...
            for results_run in results_batch:
                ...
                tracking                         = np.concatenate((tracking,  results_run[2]), axis = 0)
