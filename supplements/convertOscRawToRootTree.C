...
// The code has to be run in LXPLUS with the command
...
//
// For me, I had to redo the last two steps to be properly configured.
// Be sure to not have any errors during configuringation.
//
