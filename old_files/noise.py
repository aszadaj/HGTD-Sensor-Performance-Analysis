...
# loop over entries
for e in range(1,10): #t.GetEntries()):
    t.GetEntry(e-1)
    ...
    for chan in [t.chan0, t.chan1, t.chan2, t.chan3, t.chan4, t.chan5, t.chan6, t.chan7]:
        ...
        graphs_noise[channelCounter] = ROOT.TGraph(len(plot_channel))
...
# TO DO
# Replace the TMultiGraph with the usual dictionary TGraph
